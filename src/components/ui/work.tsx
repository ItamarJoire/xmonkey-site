...
export function Work(){
  return(
    <section className="py-16 bg-fund">
      ...
      <div className="mx-4 mt-12 md:mt-14 md:text-xl space-y-8 md:mx-20 md:grid md:grid-cols-2 lg:grid-cols-3 md:space-y-0 md:gap-8 gap-16 lg:mx-40 2xl:mx-[450px]">
        <div>
