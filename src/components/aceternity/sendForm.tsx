...
export function SendForm() {
  ...
  return (
    <div className="mt-32 absolute z-50 max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-gradient-to-t from-blue-light to-fund">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            <Label htmlFor="lastname">Tel/WhatsApp</Label>
